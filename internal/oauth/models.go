...
type tokenModel struct {
	...
	TokenFingerprint string    `bun:"token_fingerprint,notnull"`
	Scopes           string    `bun:"scopes,notnull"`
	ExpiresAt        time.Time `bun:"expires_at"`
}

func (t *tokenModel) toDomain() *EncryptedToken {
	if t == nil {
		return nil
	}
	...
	return &EncryptedToken{
		...
		Fingerprint: t.TokenFingerprint,
	}
}

func newTokenModel(userID int64, token EncryptedToken) *tokenModel {
	return &tokenModel{
